...
{
    public sealed partial class MathExpressionEvaluatorTestsUs : MathExpressionEvaluatorTestsBase
    {
        ...
        public MathExpressionEvaluatorTestsUs() : base(new CultureInfo("en-US")) { }
